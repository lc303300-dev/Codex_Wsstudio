...
- registers the video-to-GIF, Tool Scout, Codex_DT, and Codex_CS global skills;
...
`packages/Codex_Github/`, `packages/Codex_Gif/`, `packages/Codex_DT/`, and
`packages/Codex_CS/` when those package scripts are present.
