...
- registers the video-to-GIF, Tool Scout, Codex_DT, Codex_CS, and batch-image-generation global skills;
...
`packages/Codex_CS/`, and `packages/Codex_Batch_Image/` when those package scripts are present.
