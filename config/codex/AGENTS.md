...
instructions:
  ...
  - 'When a user wants to use a governed business Skill to create a video, use the globally registered video-skill-router first. Select from the user''s creative intent, then read the selected Skill contract and guide the user to provide required materials. Do not choose the Skill primarily from materials already supplied.'
