...
if (-not $SkipProjectTrust) {
    foreach ($projectPath in @($repositoryRoot, (Join-Path $repositoryRoot "packages\Codex_DT"), (Join-Path $repositoryRoot "packages\Codex_image"), (Join-Path $repositoryRoot "packages\Codex_Github"), (Join-Path $repositoryRoot "packages\Codex_CS"), (Join-Path $repositoryRoot "packages\Codex_Batch_Image"), (Join-Path $repositoryRoot "packages\Codex_IS"))) {
