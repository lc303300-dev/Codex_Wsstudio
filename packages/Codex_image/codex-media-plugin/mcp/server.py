...
def handle(message: dict) -> dict | None:
    ...
    if method == "tools/call":
        ...
        try:
            options = {key: arguments[key] for key in ("image_ratio", "image_provider", "video_duration", "video_ratio", "video_model", "video_model_selection_source", "video_execution_mode", "video_resolution") if key in arguments}
