...
Write-Host "Antigravity CLI will use the Windows default browser for authentication."
Write-Host "Proxy settings loaded from the private runtime configuration."
& $agy
exit $LASTEXITCODE
