...
$envPath = Join-Path $root "Codex_image\.codex-image-private\.env"
...
Invoke-CheckedPowerShell -File (Join-Path $root "bootstrap-new-machine.ps1") -Arguments $bootstrapArgs
